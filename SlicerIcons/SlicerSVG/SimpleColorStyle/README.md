...
**./DarkThemeIcons/** subdirectory contains corresponding icons for display on a dark slicer background (#121212). Dark theme icons are generated by swapping 4 colors from the SlicerSimpleColorPalette

Slicer core icons use the **SlicerSimpleColorPalettem** . For icon authors who wish to extend this palette, it is recommended they be:

*     global colors that work for both dark and light themese, 
...
These classes would use Slicer's SimplePalette and would be:
